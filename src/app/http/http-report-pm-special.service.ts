...
export class HttpReportPmSpecialService {
  ...
  update(id: any, data: any): Observable<any> {
    return this.http.put(this.API + "/report-pm-special/insert/" + id, data)
  }
  GetByCondition(data: any): Observable<any> {
    return this.http.post(this.API + "/report-pm-special/getByCondition/", data)
  }
}
