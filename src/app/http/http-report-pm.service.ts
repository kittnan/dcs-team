...
export class HttpReportPmService {
  ...
  update(id: any, data: any): Observable<any> {
    return this.http.put(this.API + "/report-pm/insert/" + id, data)
  }
  GetByCondition(data: any): Observable<any> {
    return this.http.post(this.API + "/report-pm/getByCondition/", data)
  }
}
